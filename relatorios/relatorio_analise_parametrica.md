...
A tabela abaixo apresenta os erros de interpolação em escala logarítmica com a redução da distância característica $h$, incluindo as estatísticas do determinante $\vert\det(A)\vert$ e o número de vizinhos $K$ efetivamente utilizados:

| Configuração | $N_{total}$ | $h_{méd}$ | $\vert\det(A)\vert_{méd}$ | $\vert\det(A)\vert_{mín}$ | $K_{méd}$ | $K_{máx}$ | Erro Médio $\vec{E}$ | Erro RMS $\vec{E}$ | Erro Máx $\vec{E}$ | Erro Médio $\nabla\times\vec{E}$ | Erro RMS $\nabla\times\vec{E}$ | Erro Máx $\nabla\times\vec{E}$ |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| Esparsa (N=84) | 84 | 3.3333 | 2.1026 | 1.0022 | 3.7 | 8 | 1.4164e-01 | 1.9714e-01 | 6.6998e-01 | 1.1291e-01 | 1.5685e-01 | 5.0293e-01 |
| Média-Esparsa (N=186) | 186 | 2.2222 | 1.6108 | 1.0048 | 4.4 | 8 | 8.9240e-02 | 1.1936e-01 | 3.9317e-01 | 8.8761e-02 | 1.3537e-01 | 5.5370e-01 |
| Média (N=416) | 416 | 1.4286 | 1.2825 | 1.0004 | 5.1 | 8 | 4.6202e-02 | 6.0065e-02 | 1.5529e-01 | 6.8760e-02 | 1.0620e-01 | 5.0012e-01 |
| Média-Densa (N=884) | 884 | 0.9524 | 1.2042 | 1.0004 | 6.6 | 12 | 3.7461e-02 | 5.0930e-02 | 1.3801e-01 | 7.3789e-02 | 1.0857e-01 | 3.8486e-01 |
| Densa (N=1928) | 1928 | 0.6250 | 1.0956 | 1.0008 | 8.6 | 15 | 2.6923e-02 | 3.6061e-02 | 1.0535e-01 | 6.0479e-02 | 8.9700e-02 | 2.9340e-01 |
| Muito Densa (N=4192) | 4192 | 0.4167 | 1.0669 | 1.0014 | 13.2 | 18 | 2.3480e-02 | 3.2446e-02 | 1.2632e-01 | 5.6871e-02 | 8.2061e-02 | 2.7129e-01 |
| Ultra Densa (N=8408) | 8408 | 0.2174 | 1.0450 | 1.0006 | 21.0 | 28 | 2.4034e-02 | 3.1764e-02 | 7.9543e-02 | 5.4649e-02 | 8.2416e-02 | 3.1690e-01 |
...
3. **Comportamento Algébrico: Determinante $\vert\det(A)\vert$ e Vizinhança Efetiva $K$:**
   - Em todas as densidades de malha com $Tol_{det} = 1.0$, o valor mínimo $\vert\det(A)\vert_{mín}$ atendeu à tolerância com 100% de sucesso nos pontos internos.
   - Como a terceira coluna da matriz $A$ é composta por termos de momento direcional $(y_i - y_P)t_{x,i} - (x_i - x_P)t_{y,i} \sim O(h)$, a magnitude de $\det(A)$ escala linearmente com $h$.
   - Para malhas padrão a moderadas ($N \le 416$), $K_{méd} \approx 3.7 - 5.1$ vizinhos e $K_{máx} \le 8$ foram suficientes para satisfazer $Tol_{det} = 1.0$.
   - Nas malhas ultra densas ($h \approx 0.22$), a busca adaptativa expandiu suavemente a vizinhança de busca até $K_{máx} = 28$ para capturar trios que atendessem ao patamar fixo de $Tol_{det}=1.0$, garantindo estabilidade e convergência numérica sem perda de precisão.
