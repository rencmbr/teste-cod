...
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| N1 (Muito Esparsa) | $9 \times 9$ | 49 | 11.73% | 30.72% | 0.006s | $4 \times 4$ | 40 |  3.19% |  8.57% | 0.002s |
| N2 (Esparsa) | $13 \times 13$ | 121 |  3.95% | 12.33% | 0.013s | $7 \times 7$ | 133 |  1.05% |  2.72% | 0.006s |
| N3 (Média-Esparsa) | $17 \times 17$ | 225 |  1.73% |  5.07% | 0.027s | $9 \times 9$ | 225 |  0.64% |  1.65% | 0.014s |
| **N4 (Caso Base)** | $21 \times 21$ | 361 | ** 1.00%** |  1.88% | 0.061s | $11 \times 11$ | 341 | ** 0.44%** |  1.10% | 0.036s |
| N5 (Média-Densa) | $25 \times 25$ | 529 |  4.46% |  6.71% | 0.144s | $14 \times 14$ | 560 |  0.27% |  0.68% | 0.121s |
| N6 (Densa) | $29 \times 29$ | 729 |  1.49% |  2.83% | 0.310s | $16 \times 16$ | 736 |  0.21% |  0.52% | 0.263s |
| N7 (Muito Densa) | $33 \times 33$ | 961 |  0.52% |  1.17% | 0.655s | $18 \times 18$ | 936 |  0.16% |  0.41% | 0.539s |
...
- **Erro Médio $k_c$ no Caso Base:** VNMM $\mathcal{P}^1$ = **1.00%** | FEM Aresta = **0.44%**
- **Erro Máximo $k_c$ no Caso Base:** VNMM $\mathcal{P}^1$ = **1.88%** | FEM Aresta = **1.10%**
